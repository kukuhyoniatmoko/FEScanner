...
@Module class ClientModule {
  ...
  internal fun providePoolClientProvider(
      @Named(DEFAULT_CLIENT_PROVIDER) okHttpClient: OkHttpClient): OkHttpClient {
  ...
  internal fun provideDefaultClientProvider(okHttpClient: OkHttpClient,
      interceptor: FERequestInterceptor): OkHttpClient {
    val builder = okHttpClient.newBuilder()
