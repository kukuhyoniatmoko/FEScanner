...
import com.foodenak.itpscanner.DependencyHolder
...
fun Context.dependencyHolder(): DependencyHolder {
    return (this.applicationContext as FEApplication).dependencyHolder
}
