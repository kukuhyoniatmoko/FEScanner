...
import com.foodenak.itpscanner.utils.dependencyHolder
import com.foodenak.itpscanner.utils.obtainApplicationComponent
import kotlinx.android.synthetic.main.activity_redeem.toolbar
...
class RedeemActivity : AppCompatActivity(), HasComponent<Component> {
    ...
    override fun onPause() {
        super.onPause()
        if (isFinishing) {
            dependencyHolder().release(this.javaClass.name)
        }
    }
    ...
    override fun component(): Component {
        synchronized(this.javaClass) {
            ...
            if (component == null) {
                ...
                dependencyHolder().hold(this.javaClass.name, component!!)
            }
        }
        return component!!
    }
    ...
    private fun createComponent(module: Module): Component {
        ...
        return DaggerComponent.builder().module(module).fEApplicationComponent(applicationComponent).build()
    }
