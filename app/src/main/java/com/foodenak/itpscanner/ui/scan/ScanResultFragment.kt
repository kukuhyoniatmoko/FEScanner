...
import kotlinx.android.synthetic.main.fragment_scan_starter.deviceIdTextView
import kotlinx.android.synthetic.main.fragment_scan_starter.rescanScanButton
import kotlinx.android.synthetic.main.fragment_scan_starter.srSubmitButton
import kotlinx.android.synthetic.main.fragment_scan_starter.userIdTextView
...
class ScanResultFragment : Fragment() {
    ...
    private fun bindView() {
        ...
        deviceIdTextView.text = if (TextUtils.isEmpty(deviceId)) getString(R.string.undefined) else deviceId
    }
