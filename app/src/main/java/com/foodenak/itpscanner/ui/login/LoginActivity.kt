...
import kotlinx.android.synthetic.main.activty_login.toolbar
...
class LoginActivity : AppCompatActivity(),
            ...
            RC_SIGN_IN -> {
                ...
                if (result.isSuccess) {
                    ...
                    if (fragment is LoginFragment) {
                        fragment.loginWithGoogle(result.signInAccount!!)
                    }
                } else {
    ...
    override fun getTwitterCredential(callback: Callback<TwitterSession>) {
        mTwitterAuthClient.authorize(this, callback);
    }

    override fun getTwitterEmail(session: TwitterSession, callback: Callback<String>) {
        mTwitterAuthClient.requestEmail(session, callback);
    }
    ...
    companion object {
        ...
        val SHOULD_LOGOUT = "SHOULD_LOGOUT"

        val STATE_DEFAULT = 0

        val RC_SIGN_IN = 9872

        private val STATE_SIGN_IN_PROGRESS = "STATE_SIGN_IN_PROGRESS"
